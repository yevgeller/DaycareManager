...
* **Requirements**:
    - Manage classroom details (Name, Capacity, Age Range).
    - Display age range as read-only labels on Edit page for clarity.
    - List assigned children on the Classroom Edit page.
    - Ensure capacity validation (future).
